...
class Escuela extends CI_Controller {
		...
		public function info_escuela_riesgoabandono(){
				...
				if($nivel_global=='PRIMARIA'){
					$tabla_riesgo = "riesgoprimb".$bimestre."c1617";
				}
				else{
					$tabla_riesgo = "riesgosecub".$bimestre."c1617";
				}
		...
		public function info_escuela_get_reactivos_xunidad_de_analisis(){
				...
				$respuesta = $this->Escuela_model->get_info_reactivos_xunidad_de_analisis($nombre, $opcion, $global_cct, $global_nombre_turno);
