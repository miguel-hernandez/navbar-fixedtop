	...
	foreach ($result as $row ) {
		...
		elseif($row['Sostenimiento_X']!=="Total" && $row['Modalidad_X']!="Total")	{
			...
			switch($row['Modalidad_X'])
			{
				...
				case 'CONAFE':  	 				$GLOBALS['valor_id_moda']="con"; break;
	...
	foreach ($result as $row ) {
		...
		elseif($row['Sostenimiento_X']!=="Total" && $row['Modalidad_X']!="Total")	{
			...
			switch($row['Modalidad_X'])
			{
				...
				case 'CONAFE':  	 				$GLOBALS['valor_id_moda']="con2"; break;
	...
	foreach ($result as $row ) {
		...
		elseif($row['Sostenimiento_X']!=="Total" && $row['Modalidad_X']!="Total")	{
			...
			switch($row['Modalidad_X'])
			{
				...
				case 'CONAFE':  	 				$GLOBALS['valor_id_moda']="con3"; break;
	...
	<thead>
		<tr class="informa">
	  	...
	  	<tr class="informa">
	    	...
	    	<th class="informa"><center>II<br><sub>Suficiente</sub></center></th>
	...
	foreach ($result as $row ) {
		...
		$html .= '<tr id="tres">
          ...
          <tr id="dieciocho">
			...
			<div class="pie_tabla">
			        <div id="fuentes_pie">Fuente: INEGI. Censo de Población y Vivienda 2015.</div>
			</div>';
...
$html = "";
$result = $this->Estadistica_model->getciclo_ze($cct);
...
$GLOBALS['valor_id_sosty']="";
$html = "";
$result = $this->Estadistica_model->get_llenado_tabla1_0_ze($cct, $ciclonomb);

$html .= '<div class="well_">
      <a name="estadistica" style="text-decoration:none; color:black;">
        <h3 id="well_">Estadística Estatal / Municipal</h3>
      </a>
      <div id="inst">
        <p class="insclic" rowspan="3">
...
<table class="table" id="tabla_estadistica_final">
	...
	$result = $this->Estadistica_model->get_llenado_tabla1_1_ze($cct, $ciclonomb);
...
public function get_llenado_tablas2_ze()
{
	...
	$GLOBALS['valor_id_sosty']="";
$html = "";
$result = $this->Estadistica_model->get_llenado_tabla2_0_ze($cct, $ciclonomb);

$html .= '<div class="well_">
      <a name="estadistica" style="text-decoration:none; color:black;">
        <h3 id="well_">Docentes y Directivos</h3>
      </a>
    </div>
    <div style="overflow-x:auto;">
<table class="table" id="tabla_estadistica_final2">
	...
	$result = $this->Estadistica_model->get_llenado_tabla2_1_ze($cct, $ciclonomb);
...
public function get_llenado_tablas3_ze()
{
	...
	$GLOBALS['valor_id_sosty']="";
$html = "";
$result = $this->Estadistica_model->get_llenado_tabla3_0_ze($cct, $ciclonomb);
...
<table class="table" id="infraestructura_t1">
	<thead>
		...
		<tr class="informa">
		  	<th class="informa">1er °</th>
		  	<th class="informa">2do °</th>
		  	<th class="informa">3er °</th>
		  	<th class="informa">4to °</th>
		  	<th class="informa">5to °</th>
		  	<th class="informa">6to °</th>
	...
	$result = $this->Estadistica_model->get_llenado_tabla3_1_ze($cct, $ciclonomb);
